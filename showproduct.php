...
$conn = db_init($config["host"], $config["duser"], $config["dpw"], $config["dname"]);
    ...
    ?>
    <?php
      $sql = "SELECT*FROM bigdata WHERE `product` = '".$value."'";
      $result = mysqli_query($conn, $sql);
      $row= mysqli_fetch_assoc($result);
      $sql2 = "SELECT `score` FROM `bigdata` WHERE `category` = '".$row['category']."'";
        ...
        <script type="text/javascript">
          ...
          function drawVisualization() {
            ...
            var data = google.visualization.arrayToDataTable([
             ['점수 비교', '이 제품', '평균치'],
             ['',  0,     <?php echo $avg; ?>],
             ['',  <?php echo $row['score']; ?>,     <?php echo $avg; ?>],
             ['',  0,     <?php echo $avg; ?>]
          ]);
      ...
      <body class="container-fluid" style="margin-bottom: 20px;margin-left: 5px;margin-right: 5px; border:1px solid red; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; border-top-left-radius: 10px; border-top-right-radius: 10px; padding-left: 0;padding-right:0">
              ...
              <article style="text-align:center;">
                      ...
                      <table class="table table-striped">
                        <tr>
                          <th colspan="1" rowspan="<?php echo $px;?>" style="vertical-align:middle;"><img src="<?php echo $row['img'];?>" style="margin: 0 auto <?php echo $px3;?>" class="img-responsive"></th>
                          <?php echo $px2;?>
                          <th colspan="1" rowspan="1" style="vertical-align:middle; font-size:25px;text-align:center"><?php echo $row['product'];?></th>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                          <td colspan="<?php echo $px;?>" rowspan="1" style="vertical-align:middle; font-size:25px;text-align:center"><h2><?php echo $row['category']." 제품 내 ".$row['no_cate']."위" ?><br><small><?php echo $row['score']." / 5.0점";?></small></h2></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                          <td  colspan="1" rowspan="1" style="vertical-align:middle;"><img src="img/wordcloud/<?php echo $row['no'];?>.gif" style="margin: 0 auto <?php echo $px3;?>" class="img-responsive" /></td>
                          <?php echo $px2;?>
                          <td  colspan="1" rowspan="1" style="vertical-align:middle; text-align:center"><div id="chart_div" style="vertical-align:middle; display: block; margin: 0 auto; width: 150px; height: 200px;"></div></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                          <td colspan="<?php echo $px;?>" rowspan="1" style="text-align:center">
                            긍정 단어<br><h2 style="color:blue"><?php echo $row["positive"] ?></h1><br>
                          </td>
                        <tr>
                        </tr>
                        <tr>
                          <td  colspan="2" rowspan="1" style="text-align:center">
                            부정 단어<br>
                            <h2 style="color:red"><?php echo $row["negative"] ?></h1>
                            <br>
                          </td>
                        </tr>
                        <tr>
